namespace :fill do
  ...
  task data: :environment do
    ...
    user = User.new(name: 'Rails', email: 'test@socialio.com', sex: 'female', password: 'password')
    user.skip_confirmation!
    user.save!
    puts 'Created test user with email=test@socialio.com and password=password'
